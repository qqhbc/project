				...
				this.control({
					...
					"categorytree":{
						itemclick:function(tree,record,item,index,e,eOpts){
							...
							if(record.raw){
								...
								treeForm.findField("parentId").setValue(record.raw.parentId);
					...
					"categorytree button[ref=treeDel]":{
						...
						click:function(btn){
							...
							Ext.MessageBox.confirm("重要提示",
								"如果删除该类别，同时也会删除该类别对应的所有商品信息，确定要删除吗？",
								function(e){
									if(e == 'yes'){
										Ext.Ajax.request({
											waitMsg : '正在进行处理,请稍后...',
											url:"./category/delete_category.htm",

...
<!-- 幻灯片end -->
	...
	<div align="center"><font color="red">申请商铺必须严格遵守《网上图书商城协议》，谢谢合作！</font></div>
	<form  name="registerShopForm" action="shop_register.htm" method="post" onSubmit="return CheckRegisterShopForm(this)" >
	<table bgcolor="#D6F7F8" align="center" border="0">
		
		<tr>
			<td>商&nbsp;户&nbsp;名:</td>
			<td><input type="text" size="25" maxlength="20" name="username" id="username" onfocus="usernameShopHint()"/>(<font color="red">*</font>)</td>
		...
		<tr>
			<td></td>
			<td><a href="agreementShop.htm">《网上图书商城服务协议》</a></td>
		</tr>
	</table>
	</form>
	</td>

...
<script type="text/javascript">
	window.onload=function(){
		if(window.parent!=window){//如果在框架中
			//就让框架页面跳转到登陆页面
...
<BODY>
<FORM id=form1 name=form1 action="${pageContext.request.contextPath}/admin/login.htm" method=post>
<DIV id=UpdatePanel1>
<DIV id=div1 
...
<TABLE cellSpacing=0 cellPadding=0 width=900 align=center border=0>
  <TBODY>
  <TR>
    <TD style="HEIGHT: 105px"><IMG src="${pageContext.request.contextPath}/images/login_1.jpg" 
  border=0></TD></TR>
  <TR>
        ...
        <TR>
          ...
          <TD>
            <TABLE cellSpacing=0 cellPadding=2 border=0>
              ...
              <TR>
                <TD style="HEIGHT: 18px" colspan="2"><font style="color: red;">${error}</font></TD>
